function CInterface(){
    ...
    this._init = function(){                  
        ...
        _oScoreNumShadow = new createjs.Text("0","40px "+FONT, "#000");
        _oScoreNumShadow.x = oSpriteTimeBarBg.width/2;
        _oScoreNumShadow.y = oSpriteTimeBarBg.height/2-4;
        _oScoreNumShadow.textAlign = "center";
        _oScoreNumShadow.textBaseline = "middle";
        _oScoreNumShadow.lineWidth = 200;
	_oScoreNumShadow.outline = 5;
        _oContainerScore.addChild(_oScoreNumShadow);
        
        _oScoreNum = new createjs.Text("0","40px "+FONT, "#ffb557");
        _oScoreNum.x = oSpriteTimeBarBg.width/2;
        _oScoreNum.y = oSpriteTimeBarBg.height/2-4;
	...
	_oTextMultOutline.outline = 3;
        ...
        _oBestScoreNumShadow = new createjs.Text(s_iBestScore,"40px "+FONT, "#000");
        _oBestScoreNumShadow.x = oSpriteTimeBarBg.width/2;
        _oBestScoreNumShadow.y = oSpriteTimeBarBg.height/2-4;
        _oBestScoreNumShadow.textAlign = "center";
        _oBestScoreNumShadow.textBaseline = "middle";
	_oBestScoreNumShadow.outline = 5;
        _oContainerBestScore.addChild(_oBestScoreNumShadow);
        
        _oBestScoreNum = new createjs.Text(s_iBestScore,"40px "+FONT, "#ffb557");
        _oBestScoreNum.x = oSpriteTimeBarBg.width/2;
        _oBestScoreNum.y = oSpriteTimeBarBg.height/2-4;
        _oBestScoreNum.textAlign = "center";
        _oBestScoreNum.textBaseline = "middle";
        _oContainerBestScore.addChild(_oBestScoreNum);
    ...
    this.refreshBestScore = function(){
        _oBestScoreNumShadow.text = _oBestScoreNum.text = s_iBestScore;
    };
