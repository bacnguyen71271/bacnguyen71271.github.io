function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./assets/progress_bar.png");
        s_oSpriteLibrary.addSprite("hm_logo", "./assets/hm_logo.png");
        s_oSpriteLibrary.addSprite("but_start", "./assets/but_start.png");
    ...
    this.attachSprites = function () {
        ...
        oBg.graphics.beginFill("#0773b8").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        _oContainer.addChild(oBg);

        var oSprite = s_oSpriteLibrary.getSprite('hm_logo');
        _oIcon = createBitmap(oSprite);
        _oIcon.regX = oSprite.width * 0.5;
        _oIcon.regY = oSprite.height * 0.5;
        _oIcon.x = CANVAS_WIDTH/2;
        _oIcon.y = CANVAS_HEIGHT/2 - 100;
        _oContainer.addChild(_oIcon);

        _oIconMask = new createjs.Shape();
        _oIconMask.graphics.drawRoundRect(_oIcon.x - 100, _oIcon.y - 100, 200, 200, 0);
        ...
        _oLoadingText = new createjs.Text("", "30px showcard", "#fff");
        ...
        _oButStart = new CTextButton(CANVAS_WIDTH/2, CANVAS_HEIGHT/2, oSprite, "START", "Arial", "#000", "bold "+ 50, _oContainer);        
    ...
    this.refreshLoader = function (iPerc) {
        _oLoadingText.text = "Đang tải ... " + iPerc + "%";
