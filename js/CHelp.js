function CHelp(){
    ...
    this._init = function(){
        ...
        var oScoreNum = new createjs.Text(szText,"50px "+FONT, "#ffcb00");
        oScoreNum.x = oCharacter.getX();
        oScoreNum.y = oScorePanel.y + 56;
        oScoreNum.textAlign = "center";
      ...
      /////////////CHARACTER 4
        ...
        var oScoreNum = new createjs.Text(szText,"50px "+FONT, "#ff1800");
        oScoreNum.x = oCharacter.getX();
        oScoreNum.y = oScorePanel.y + 56;
        oScoreNum.textAlign = "center";
        oScoreNum.textBaseline = "alphabetic";
